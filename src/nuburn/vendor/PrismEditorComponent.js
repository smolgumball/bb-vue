...
export default function() {
  ...
  var PrismEditor = /*#__PURE__*/ Vue.defineComponent({
      ...
      _recordChange: function _recordChange(record, overwrite) {
        ...
        if (overwrite) {
          ...
          if (last && timestamp - last.timestamp < HISTORY_TIME_GAP) {
            ...
            var previous =
              (_this$_getLines$pop = this._getLines(last.value, last.selectionStart).pop()) ===
                null || _this$_getLines$pop === void 0
                ? void 0
                : _this$_getLines$pop.match(re) // Get the current line

            var current =
              (_this$_getLines$pop2 = this._getLines(record.value, record.selectionStart).pop()) ===
                null || _this$_getLines$pop2 === void 0
                ? void 0
                : _this$_getLines$pop2.match(re)
    ...
    render: function render() {
      ...
      var lineNumberWidthCalculator = Vue.h(
        'div',
        {
